...
INSERT INTO Producto (`ID_Producto`, `Nombre_Producto`, `Descripcion`, `Precio`, `Stock`, `Talle`, `Descuento`, `Ruta_Imagen`, `ID_Proveedor`, `ID_Categoria`) 
	VALUES (NULL, 'Mascara Soldador', 'Mascara de Soldador.', '2000', '15', '', '0', 'MASCARA SOLDADOR $2700.jpg', '1', '3'), 
			(NULL, 'Arnés', 'Arnés completo con 3 puntos de enganche, regulable en hombros y piernas. Talle M', '2920', '20', 'M', '0', 'ARNES $2920.jpg', '2', '1'),
			(NULL, 'Botas de Lluvia Blanco', 'Producto desarrollado con material maleable, cabedal con 2,7mm de espesor, con diseño que facilita el calzado y descalzar. Talle 42', '598', '30', '42', '0', 'BOTAS DE LLUVIA $598.jpg', '1', '2'),
			...
			(NULL, 'Botas de Lluvia con Puntera', 'Botas de lluvia con puntera, Producto desarrollado con material maleable, cabedal Constituida en PVC (Policloruro de vinilo). Talle 40', '1150', '15', '40', '0', 'BOTAS DE LLUVIA CON PUNTERA $1150.jpg', '1', '2');
INSERT INTO Producto (`ID_Producto`, `Nombre_Producto`, `Descripcion`, `Precio`, `Stock`, `Talle`, `Descuento`, `Ruta_Imagen`, `ID_Proveedor`, `ID_Categoria`) 
VALUES (NULL, 'Campera con Reflectivo', 'Composición: Micropolar 100% Polyester Gramaje: 260g. Talle L', '1100', '19', 'L', '0', 'CAMPERA CON REFLECTIVO $1100.jpg', '1', '1'),
		(NULL, 'Campera Micropolar con Reflectivo', '100% Polyester Gramaje: 120 Gramos. Talle XL', '125', '50', 'XL', '0', 'CAMPERA MICROPOLAR CON REFLECTIVO $125.jpg', '1', '1'), 
		...
		(NULL, 'Delantal de Soldador', 'Confeccionado en cuero descarne. Diseño sin costuras. 60 x 90 cm en una sola pieza. Talle XL', '1020', '50', 'XL', '0', 'DELANTAL DE SOLDADOR $1020.jpg', '2', '1'),
		(NULL, 'Equipo de Lluvia con Reflectivo', 'Ropa de protección frente a la lluvia. Talle L', '898', '15', 'L', '0', 'EQUIPO DE LLUVIA CON REFLECTIVO $898.jpg', '1', '1'),
		(NULL, 'Faja Lumbar', '100% elastizada. Doble ajuste / velcro de máxima adherencia. 5 ballenas de PVC con memoria. Cinta reflectiva trasera. Acentúa la flexibilidad muscular. \r\nOtorga calor terapéutico en la zona lumbar. Mediante una confortable compresión reduce la presión sobre ligamentos, discos y vértebras. Talle XL', '598', '20', 'XL', '0', 'FAJA LUMBAR $598.jpg', '2', '1'),
...
INSERT INTO Producto (`ID_Producto`, `Nombre_Producto`, `Descripcion`, `Precio`, `Stock`, `Talle`, `Descuento`, `Ruta_Imagen`, `ID_Proveedor`, `ID_Categoria`)
 VALUES (NULL, 'Guantes de Seguridad', 'Guante de seguridad hecha de cuero de vaca con la palma, la palma\r\nde los dedos, el pulgar y los dedos; nylon en la parte posterior.', '990', '16', '', '0', 'GUANTES DE SEGURIDAD $990.jpg', '2', '3'),
	...
	(NULL, 'Zapato de Seguridad con Puntera', 'Material cuero Puntera pvc Hecho en Brasil.\r\n Talle 43', '850', '15', '43', '0', 'ZAPATO DE SEGURIDAD CON PUNTERA $850.jpg', '1', '2'),
	(NULL, 'Zapato de Seguridad sin Puntera', 'Talle 44\r\nResistente al impacto hasta 200J. \r\nPlantilla sintética, cosida en sistema strobel antibacteriana. \r\nSuela de PU bidensidad, inyectado directamente en la capellada. Talle 44', '1050', '15', '44', '0', 'ZAPATO DE SEGURIDAD SIN PUNTERA $1050.png', '1', '2');
...
SELECT ID_Producto,Nombre_Producto,Precio,Ruta_Imagen,Stock
FROM Producto GROUP BY Precio limit 10;
