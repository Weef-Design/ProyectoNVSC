$(document).ready(function () {
        ...
        response.forEach(element => {
            ...
            $("#tablaCarrito tbody").append(
                ...
                <tr>
                    ...
                    <td>
                        ${element['cantidad']}
                        <button type="button" class="btn-xs btn-warning mas" 
                        data-id="${element['id']}"
                        data-tipo="mas"
                        >+</button>
                        <button type="button" class="btn-xs btn-warning menos" 
                        data-id="${element['id']}"
                        data-tipo="menos"
                        >-</button>
                    </td>
    ...
    function llenaCarrito(response){
        ...
        $("#listaCarrito").text("Carrito Vacío");
        response.forEach(element => {
            $("#listaCarrito").text("");
            $("#listaCarrito").append(
                `
    ...
    var telefonoRec=$("#telefonoRec").val();
    $("#tomarDatosEnvio").click(function (e) { 
