...
?>
    <nav aria-label="Page navigation">
        <ul class="pagination text-center d-flex align-items-center justify-content-center">
            ...
            ?>
                <li class="page-item">
                    <a class="page-link" href="index.php?modulo=seguridad&idCategoria=3&pagina=<?php echo ($paginaSel - 1); ?>" aria-label="Previous">
            ...
            ?>
                <li class="page-item <?php echo ($paginaSel == $i) ? " active " : " "; ?>">
                    <a class="page-link" href="index.php?modulo=seguridad&idCategoria=3&pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                </li>
            <?php
            }
            ?>
            ...
            ?>
                <li class="page-item">
                    <a class="page-link" href="index.php?modulo=seguridad&idCategoria=3&pagina=<?php echo ($paginaSel + 1); ?>" aria-label="Next">
