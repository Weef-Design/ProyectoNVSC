...
$sql = "SELECT ID_Usuario, NombreUsuario FROM Usuario U
        where ID_Usuario='$compradorID';";
// EJECUTAR SENTENCIA SQL
$result = $conex->query($sql);
if (mysqli_num_rows($result)==0) {
    echo '<script language="javascript">alert("Comprador Inexistente");window.location.href="../pages/crudempleados.php";</script>';
    } else {
    ...
    <div class="container-fluid">
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3 sidebar-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../pages/crudproductos.php">
                                <span data-feather="shopping-cart" class="align-text-bottom"></span>
                                Productos
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="../pages/crudempleados.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form id="frmBajaVendedor" action="../sql/bajaVendedor.php" method="post">
                    ...
                    <input class="btn btn-warning" type="button" value="Eliminar" id="vendedorDel">
                </form>
                ...
                <form id="frmBajaComprador" action="../sql/bajaComprador.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="compradorID">Identificador</label>
                            <input class="form-control form-control-sm" type="number" value="<?php echo $reg['ID_Usuario']; ?>" name="compradorID" id="compradorID"><br>
                        </div>
                        <div class="col-md-6">
                            <label for="compradorName">Nombre</label>
                            <input class="form-control form-control-sm" type="text" value="<?php echo $reg['NombreUsuario']; ?>" name="compradorName" disabled="true" id="compradorName"><br>
                        </div>
                    </div>
