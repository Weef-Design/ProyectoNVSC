...
$sql = "SELECT ID_Producto, Nombre_Producto FROM Producto WHERE ID_Producto='$productID'";
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <form id="frmBajaProducto" action="../sql/bajaProducto.php" method="post">

                    <label for="productID">Identificador</label>
                    <input class="form-control form-control-sm" type="number" value="<?php echo $reg['ID_Producto']; ?>" name="productID" id="productID">

                    <label for="productNombre">Nombre</label>
                    <input class="form-control form-control-sm" type="text" name="productNombre" value="<?php echo $reg['Nombre_Producto']; ?>" disabled="true" id="productNombre"><br>
                ...
                <div class="form-signin w-100 m-auto">
                    ...
                    <form id="frmUpdProducto" action="../sql/updateProductoConfirma.php" method="post">
                        <label for="productIDUpd">Identificador</label>
                        <input class="form-control form-control-sm" type="number" name="productIDUpd" id="productIDUpd"><br>
