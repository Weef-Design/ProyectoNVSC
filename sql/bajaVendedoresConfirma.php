...
$sql = "SELECT ID_Usuario, NombreUsuario FROM Usuario
        where ID_Usuario='$vendedorID';";
// EJECUTAR SENTENCIA SQL
$result = $conex->query($sql);
if (mysqli_num_rows($result)==0) {
    echo '<script language="javascript">alert("Vendedor Inexistente");window.location.href="../pages/crudempleados.php";</script>';
    } else {
                ...
                <form id="frmBajaVendedor" action="../sql/bajaVendedor.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input class="form-control form-control-sm" type="number" value="<?php echo $reg['ID_Usuario']; ?>" name="vendedorID" id="vendedorID">
                        </div>
                        <div class="col-md-6">
                            <label for="userName">Nombre</label>
                            <input class="form-control form-control-sm" type="text" value="<?php echo $reg['NombreUsuario']; ?>" name="userName" disabled="true" id="userName"><br>
                        </div>
                    </div>
